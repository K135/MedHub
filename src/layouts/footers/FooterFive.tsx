                    ...
                    <div className="cta-wrapper-5">
                        <div className="section-title text-center">
                            ...
                            <h2 className="text-white wow fadeInUp" data-wow-delay=".3s">
                                Join 15,000+ Healthcare Professionals <br />
                                Using MedHub for CME & CPD
                            </h2>
                        </div>
                        <Link href="/courses" className="theme-btn mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".3s">Browse Courses Now</Link>
                    </div>
                </div>
            </div>
            <div className="container">
                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div className="single-footer-widget">
                                <div className="widget-head">
                                    <Link href="/">
                                        <img src="assets/img/logo/medhub logo.png" alt="img" style={{maxHeight: "60px", width: "auto"}} />
                                    </Link>
                                </div>
                                <div className="footer-content">
                                    <p>Subscribe to get the latest CME/CPD updates and medical insights</p>
                        ...
                        <div className="col-xl-5 col-lg-5 col-md-6 ps-lg-5 wow fadeInUp" data-wow-delay=".4s">
                            <div className="single-footer-widget style-left">
                                <div className="widget-head">
                                   <h4>Ready to Advance <br /> Your Medical Career?</h4>
                                </div>
                                <div className="contact-list-area">
                                    <ul>
                                        <li>
                                            <span>Get In Touch</span>
                                            <a href="mailto:info@medhub.me" className="link">info@medhub.me</a>
                                            <a href="tel:+971123456789">+971 (12) 345 6789</a>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
            ...
            <div className="footer-bottom style-3 style-5">
                <div className="container">
                    <div className="footer-bottom-wrapper">
                        <p className="wow fadeInUp" data-wow-delay=".3s">Copyright © <Link href="/">MedHub Middle East</Link>, all rights reserved.</p>
