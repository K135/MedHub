                            ...
                            <div className="about-content">
                                <div className="section-title color-blue">
                                    ...
                                    <h2 className="wow fadeInUp" data-wow-delay=".3s">
                                        Region's Dedicated Medical Education Hub
                                    </h2>
                                </div>
                                <p className="mt-4 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                        MedHub is the region's dedicated medical education hub — designed to simplify CME and CPD for healthcare professionals and event organizers. From Dubai to Doha, Riyadh to Muscat, we bring together the ecosystem of continuing medical education: physicians, nurses, speakers, and healthcare partners.
                                </p>
                                <div className="circle-progress-bar-wrapper">
                                    <div className="single-circle-bar wow fadeInUp" data-wow-delay=".3s">
                                        ...
                                        <div className="content">
                                            <h6>
                                                Healthcare <br /> Professional Satisfaction
                                            </h6>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                                        <ul className="list">
                                            <li>
                                                ...
                                                Accredited by DHA, DOH, MOHAP
                                            </li>
                                            <li>
                                                <i className="fas fa-check-circle"></i>
                                                Recognized CME/CPD Credits
                                            </li>
                                            <li>
                                                <i className="fas fa-check-circle"></i>
