                   ...
                   className="swiper testimonial-slider-5">
                      ...
                      <SwiperSlide className="swiper-slide">
                          <div className="testimonial-card-items-2">
                              ...
                              <h3>"MedHub made CME tracking and accreditation so simple. It's now my go-to for professional development."</h3>
                              <div className="star">
                        ...
                        <SwiperSlide className="swiper-slide">
                            <div className="client-info">
                                ...
                                <div className="content">
                                    <h3>Dr. Rania K.</h3>
                                    <span>Consultant Cardiologist, Dubai</span>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide className="swiper-slide">
                            <div className="client-info">
                                ...
                                <div className="content">
                                    <h3>Fatima A.</h3>
                                    <span>Registered Nurse, Abu Dhabi</span>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide className="swiper-slide">
                            <div className="client-info">
                                ...
                                <div className="content">
                                    <h3>Dr. Ahmed S.</h3>
                                    <span>Endocrinologist, Riyadh</span>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide className="swiper-slide">
