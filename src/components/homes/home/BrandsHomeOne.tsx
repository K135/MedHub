					...
					<div className="brand-wrapper">
						<div className="section-title text-center">
							...
							<p className="wow fadeInUp" data-wow-delay=".5s mt-3">
								Partnering with healthcare institutions, medical societies, and life sciences companies <br />
								to deliver world-class CME and CPD education across the Middle East.
							</p>
						</div>
						<Swiper
             spaceBetween={30}
