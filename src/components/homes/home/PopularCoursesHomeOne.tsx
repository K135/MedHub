                ...
                <div className="section-title-area align-items-end">
                    ...
                    <ul className="nav">
                        ...
                        <li className="nav-item wow fadeInUp" data-wow-delay=".4s">
                            <a href="#Cardiology" data-bs-toggle="tab" className="nav-link">
                                Cardiology
                            </a>
                        </li>
                        <li className="nav-item wow fadeInUp" data-wow-delay=".6s">
                            <a href="#Nursing" data-bs-toggle="tab" className="nav-link">
                                Nursing
                            </a>
                        </li>
                        <li className="nav-item wow fadeInUp" data-wow-delay=".8s">
                            <a href="#EmergencyMedicine" data-bs-toggle="tab" className="nav-link">
                                Emergency Medicine
                            </a>
                        </li>
                    </ul>
