                        ...
                        <div className="col-lg-5">
                            <div className="section-title color-red">
                                ...
                                <h2 className="wow fadeInUp" data-wow-delay=".3s">
                                    300+ Partner Institutions & Organizations
                                </h2>
                                <p className="mt-3 wow fadeInUp" data-wow-delay=".5s">
                                    MedHub partners with leading hospitals, medical universities, regulatory authorities, and pharmaceutical organizations to deliver world-class medical education across the GCC region.
                                </p>
                            </div>
                        </div>
